        ...
        var switching = (function() {
            ...
            return {
                ...
                to: function(toIndex, opt) {
                    ...
                    var currentContents = $(".contents", viewport).eq(toIndex);
                    currentContents.parent().parent().height(currentContents.height());

                    ret.current = toIndex;
                    changedView(toIndex);
                    if (options.afterMove) {
                        options.afterMove(toIndex);
                    }
                },
